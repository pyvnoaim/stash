...
const rows = merge(
  [
    { symbol: 'pf_xbtusd', side: 'long', price: 100, size: 0.5 },
...
// a long that rose and a short that fell are both in your favour: both pct positive
assert.deepEqual(rows[0], { symbol: 'PF_XBTUSD', side: 'long', size: 0.5, entry: 100, mark: 110, pct: 10 })
...
assert.deepEqual(rows[2], { symbol: 'PF_SOLUSD', side: 'long', size: 10, entry: 50, mark: null, pct: null })
